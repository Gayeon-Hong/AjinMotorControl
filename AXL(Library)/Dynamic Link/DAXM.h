...
typedef DWORD    PASCAL EXPORT funcAxmStatusGetAmpActPos(long lAxisNo, double *dpPos);
...
typedef DWORD    PASCAL EXPORT funcAxmOverrideAccelVelDecelAtMultiPos(long lAxisNo, double dPosition, double dVelocity, double dAcceleration, double dDeceleration, long lArraySize, double* dpOverridePosition, double* dpOverrideVelocity, double* dpOverrideAccel, double* dpOverrideDecel, long lTarget, DWORD dwOverrideMode);
...
typedef DWORD	 PASCAL EXPORT funcAxmContiResetAxisMap(long lCoordinate);
...
extern funcAxmStatusGetAmpActPos                *AxmStatusGetAmpActPos;
...
extern funcAxmOverrideAccelVelDecelAtMultiPos 	*AxmOverrideAccelVelDecelAtMultiPos;
