...
Public Const AXT_PCIE_Rxx05ECAT = &HD8                      ' PCIe bus, Half size, ECAT(DSP Based) controller.
Public Const AXT_PCI_Rxx05MLIII = &HD9                      ' PCI bus, Half size, Mechatrolink III 32 axis(DSP Based) controller.
Public Const AXT_PCI_Rxx05SIIIH = &HDA                      ' PCI bus, Half size, Sscnet III / H  32 axis(DSP Based) controller.
Public Const AXT_PCI_Rxx05RTEX = &HDB                       ' PCI bus, Half size, RTEX 32 axis(DSP Based) controller.
Public Const AXT_PCI_Rxx05ECAT = &HDC                       ' PCI bus, Half size, ECAT(DSP Based) controller.
...
Public Const AXT_SIO_RMEMORY_MLIII = &HCC                   ' Memory Access type module, MechatroLink III
Public Const AXT_SIO_RAVCI8MLII = &HCE			    ' DC VOLTAGE/CURRENT INPUT MODULE, 8 points (Product by M-SYSTEM), For MLII only
Public Const AXT_SIO_RDB64MSMLIII = &HD0		    ' DIO slave module, MechatroLink III M-SYSTEM, IN 32-Channel, OUT 32-Channel
Public Const AXT_SIO_RDI16MSMLIII = &HD1		    ' DI slave module, MechatroLink III M-SYSTEM, IN 16-Channel
...
Public Const AXT_RT_CNT_NOT_TRIGGER_ENABLE = 3253           ' CNT Trigger Ãâ·Â ±â´ÉÀÌ È°¼ºÈ­µÇ¾î ÀÖÁö ¾ÊÀ½
...
Public Const AXT_RT_CNT_CMD_EXE_TIMEOUT = 3308				' CNT ¸ğµâ µ¥ÀÌÅÍÀÔ·Â ½Ã°£ÃÊ°ú ÇßÀ»¶§
Public Const AXT_RT_CNT_INVALID_VELOCITY = 3309				' À¯È¿ÇÏÁö¾Ê´Â CNT ¼Óµµ
Public Const AXT_RT_PROTECTED_DURING_PWMENABLE = 3310		' PWM Enable µÇ¾î ÀÖ´Â »óÅÂ¿¡¼­ »ç¿ë ¸ø ÇÔ
Public Const AXT_RT_CNT_INVALID_TABLEPOS = 3311				' À¯È¿ÇÏÁö ¾ÊÀº CNT TABLE ¹øÈ£ 
Public Const AXT_RT_CNT_DIMENSION_ERROR = 3312				' ÇØ´ç Dimension ¼³Á¤ »óÅÂ¿¡¼­´Â »ç¿ëÇÒ ¼ö ¾øÀ½
...
Public Const AXT_ERROR_HELICAL_ZPOS_DISTANCE_ZERO = 4173	' Çï¸®ÄÃ ¸ÊÇÎµÈ ZÃàÀÇ ÀÌµ¿·®ÀÌ 0ÀÏ ¶§
...
Public Const AXT_RT_ERROR_RING_COUNTER_ENABLE = 4420           ' Ring Counter ±â´ÉÀÌ »ç¿ë Áß
Public Const AXT_RT_ERROR_RING_COUNTER_OUT_OF_RANGE = 4421     ' Ring Counter »ç¿ë Áß ¹üÀ§ ¹Û ¸í·É À§Ä¡ È£Ãâ(POS_ABS_LONG_MODE or POS_ABS_SHORT_MODE ÀÏ °æ¿ì)
Public Const AXT_RT_ERROR_SOFT_LIMIT_ENABLE = 4430             ' Software Limit ±â´ÉÀÌ »ç¿ë Áß
Public Const AXT_RT_ERROR_SOFT_LIMIT_NEGATIVE = 4431           ' ÀÌµ¿ÇÒ À§Ä¡°¡ Negative Software LimitÀ» ¹ş¾î³²
Public Const AXT_RT_ERROR_SOFT_LIMIT_POSITIVE = 4432           ' ÀÌµ¿ÇÒ À§Ä¡°¡ Positive Software LimitÀ» ¹ş¾î³²
...
Public Const INTERPOLATION_AXIS2 = &H2                      ' 2ì¶•ì„ ë³´ê°„?¼ë¡œ ?¬ìš©????
Public Const INTERPOLATION_AXIS3 = &H3                      ' 3ì¶•ì„ ë³´ê°„?¼ë¡œ ?¬ìš©????
Public Const INTERPOLATION_AXIS4 = &H4                      ' 4ì¶•ì„ ë³´ê°„?¼ë¡œ ?¬ìš©????
